---
description: Routine read-only implementation reviewer. Use after Build completes code and verification; returns evidence-backed findings for Build to assess.
mode: subagent
